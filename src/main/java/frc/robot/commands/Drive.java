...
public class Drive extends CommandBase {
  ...
  @Override
  public void execute() {
    revDrivetrain.drive(revDrivetrain.deadband((xbox.getRawAxis(kLeftY.value))*.75, percentDeadband), 
    revDrivetrain.deadband((xbox.getRawAxis(kRightY.value)) *.75, percentDeadband));
