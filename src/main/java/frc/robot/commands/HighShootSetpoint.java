...
public class HighShootSetpoint extends SequentialCommandGroup {
  ...
  public HighShootSetpoint (Elevator elevatorSubsystem, Carriage carriageSubsystem, MoveWristLevel3 moveWristLevelCommand) {
